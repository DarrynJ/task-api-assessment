...
namespace Tasks.Application.Application.Common.Pagination
{
    public static class PagedResultMappingExtensions
    {
        ...
        public static PagedResult<TDto> MapToPagedResult<TDomain, TDto>(this IPagedResult<TDomain> pagedList, Func<TDomain, TDto> mapFunc)
        {
